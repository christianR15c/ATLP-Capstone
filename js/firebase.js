const firebaseConfig = {
  apiKey: 'AIzaSyADTuOXe1Yhy_VkwGJotB_ucx_qvg1kzHE',
  authDomain: 'capstone-43ae2.firebaseapp.com',
  projectId: 'capstone-43ae2',
  storageBucket: 'capstone-43ae2.appspot.com',
  messagingSenderId: '800223328210',
  appId: '1:800223328210:web:64f2cf6fbd4cbd63817a0b',
};
...
selectedImage.addEventListener('change', (e) => {
  ...
  document.getElementById(
    'imageName'
  ).innerHTML = `<label id="myImageName">${name}${extension}</label>`;
